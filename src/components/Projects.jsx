                ...
                <div className="grid md:grid-cols-2 gap-8">
                    {projects.map((project, index) => (
                        ...
                        >
                            ...
                            {/* Hover Glow Effect */}
                            <div className="absolute inset-0 bg-linear-to-br from-cyan-400/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
                        </motion.div>
                    ))}
                </div>
            </div>
